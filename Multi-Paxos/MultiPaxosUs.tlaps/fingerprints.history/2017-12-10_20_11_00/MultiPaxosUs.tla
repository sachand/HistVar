...
(***************************************************************************)
EXTENDS Integers, TLAPS, FiniteSets, Sequences, FiniteSetTheorems
...
VARIABLES sent             \* The set of messages that have been sent.
        ...
        <6>3. (\A d1,d2 \in m.decrees: d1.slot = d2.slot => d1 = d2)'
          <7>1. \A m2 \in sent' \ sent: \A d1,d2 \in m2.decrees: d1.slot = d2.slot => d1 = d2
            ...
            <8>5. \A r1, r2 \in PartialBmax(VS(S, Q)): r1.slot = r2.slot => r1.bal = r2.bal /\ r1.val = r2.val
                  BY <8>4, <8>2, <8>3, <8>1
            <8>6. \A r1, r2 \in Bmax(VS(S, Q)): r1.slot = r2.slot => r1 = r2  BY <8>5 DEF Bmax
            <8> HIDE DEF VS
